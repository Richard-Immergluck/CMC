...
- Strengthen auth lifecycle behavior around inactive accounts and account state transitions.

## Next Targets

- Normalize signed URL audit metadata across sample, review, full, and download modes.
