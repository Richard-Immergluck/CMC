...
export const trackRequestPricingProposalBodySchema = yup
  .object({
    catalogueType: yup.string().oneOf(Object.values(catalogueTypes)).default(catalogueTypes.singleTrack),
    saleFormat: yup.string().oneOf(Object.values(saleFormats)).default(saleFormats.individual),
