...
export const auditEventCategories = {
  ...
  releaseLifecycle: [
    'works_collection.archived',
    'works_collection.created',
    'works_collection.deleted',
    'works_collection.dependency_blocked',
    'works_collection.dependency_repaired',
    'works_collection.pricing_reviewed',
    'works_collection.updated'
  ],
  uploadLifecycle: [
    'upload_batch.created',
    'upload_batch.failed_track_removed',
    'upload_batch.moderation_completed',
    'upload_batch.submitted',
    'upload_batch.updated'
  ]
}
