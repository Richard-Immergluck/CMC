...
export const atomicTrackCatalogueTypes = [
  catalogueTypes.singleTrack,
  catalogueTypes.movement,
  catalogueTypes.operaExcerpt
]

export const worksAndCollectionsCatalogueTypes = [
...
export const trackTypeLabels = {
  [catalogueTypes.singleTrack]: 'Song, aria, study, or warmup',
  [catalogueTypes.movement]: 'Movement or substantial excerpt',
  [catalogueTypes.operaExcerpt]: 'Opera number or specialist cut'
}

export const worksAndCollectionsTypeLabels = {
  [catalogueTypes.learningPack]: 'Learning pack',
  [catalogueTypes.songCycle]: 'Song cycle',
  [catalogueTypes.collection]: 'Collection',
  [catalogueTypes.completeWork]: 'Complete work'
}
...
export const isAtomicTrackCatalogueType = catalogueType => atomicTrackCatalogueTypes.includes(catalogueType)

export const isWorksAndCollectionsCatalogueType = catalogueType => worksAndCollectionsCatalogueTypes.includes(catalogueType)
